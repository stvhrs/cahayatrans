                                          ...
                                          child: Column(children: [    _buildSize(
                                            ...
                                            _buildSize2(
                                                ...
                                                controller: controlerMobil,
                                                  ...
                                                  }catch(e){ controlerMobil.text = value;}
                                                  }
                                                ),
                                                'Pilih No Pol',
                                                1),
                                            _buildSize(
                                                ...
                                                1),
                                            _buildSize2(
                                                DropDownField(controller: controlerSupir,
                                                  ...
                                                  }catch(e){   controlerSupir.text = value;}},
                                                ),
                                                "Pilih Driver",
                                                1),
                                            _buildSize(
                                            ...
                                            ElevatedButton.icon(
                                                ...
                                                onPressed: () {
                                                  ...
                                                  Transaksi.fromMap({
                                                    ...
                                                    "keluar": "0",
                                                    "sisa": "0",
                                                    "sender":Provider.of<ProviderData>(context,listen: false).user.username
                                                  });
                                                  fd.requestFocus();
                                                  controlerMobil.text = "";
                                                     controlerSupir.text = "";
                                                  ...
                                                  onPressed: (transaksi.sisa <= 0 ||
                                                      ...
                                                      : () {
                                                           Transaksi temp = Transaksi(
                                                              ...
                                                              transaksi.keluar,
                                                              transaksi.ongkos,
                                                              transaksi.sisa,Provider.of<ProviderData>(context,listen: false).user.username);
                                                ...
                                                for (var element
                                                  ...
                                                  var data = await Service
                                                    ...
                                                    "keluar": element.keluar
                                                        .toString(),
                                                    "sisa":
                                                        element.sisa.toString(),"sender":Provider.of<ProviderData>(context,listen: false).user.username
                                                  });
