...
class _KasTahunState extends State<KasTahun> {
  List<int> tahun = [];bool enable=true; String value = "Semua";
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              SizedBox(
                ...
                child: ListView(padding: EdgeInsets.only(right: 20),
                  children:
                      Provider.of<ProviderData>(context).backupListMobil .where((element) => value == "Semua"
                                ? element.nama_mobil.isNotEmpty
                                : element.nama_mobil == value).map((e) {
  ...
  listKas.add(kasModel);
            ...
            child: SizedBox(
              width: 200,
              child: LaporanDropDownField(enabled: enable,
                value: value,height: 30,
                ...
                onValueChanged: (va) {
                    ...
                    if (va != "Semua") {
                        ...
                        if(listKas.map((e) => e.namaMobil.toString()).contains(va)){
